...
public class AgendamentoController {
    ...
    public String salvarAgendamento(@PathVariable long id,
        ...
        Boolean ativo = null;
        repeat = nonNull(repeat) && repeat;
        random = nonNull(random) && random;

        validarCronExpression(cronExpression);

        Agendamento agendamento = switch (tipo) {
            case MUSICA -> salvarAgendamentoMusica(id, albumNome, musicaNome, repeat, ativo, nome, cronExpression);
            case ALBUM -> salvarAgendamentoAlbum(id, albumNome, repeat, random, ativo, nome, cronExpression);
            case PLAYLIST -> salvarAgendamentoPlaylist(id, playlistNome, repeat, random, ativo, nome, cronExpression);
